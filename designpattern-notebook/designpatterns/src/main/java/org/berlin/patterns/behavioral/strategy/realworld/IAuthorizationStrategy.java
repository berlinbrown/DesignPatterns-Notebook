...
public interface IAuthorizationStrategy
{
	...
	public static final IAuthorizationStrategy ALLOW_ALL = new IAuthorizationStrategy()
	{
		 ...
		 */
		public <T> boolean isInstantiationAuthorized(final Class<T> c)
		{
			return true;
		}
		 ...
		 */
		public boolean isActionAuthorized(Object c, Object action)
		{
			return true;
		}
	};
	 ...
	 */
	boolean isActionAuthorized(Object component, Object action);
}
