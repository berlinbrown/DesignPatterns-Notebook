 ...
 */
public abstract class AjaxPostprocessingCallDecorator implements IAjaxCallDecoratorWICKET {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private final IAjaxCallDecoratorWICKET delegate;
	 ...
	 */
	public AjaxPostprocessingCallDecorator(final IAjaxCallDecoratorWICKET delegate) {
